...
//        await prms;
    ...
    _showErrorWarning(aAction, aHeader, aError, aComment) {
        ...
        if (aError.message.indexOf("Unknown Bolt protocol version") > -1) {
...
//        console.log("after show")
    ...
    async getNeo4jVersion(dbName, pw) {
        ...
        if (this.neodb.isCluster) {
            let cls = await this.runQuery(session, "call dbms.cluster.overview() yield addresses, databases \n" +
