...
class QueryAnalyzer {
        ...
        for (let i = 0 ; i < anas.length; i++) {
            ...
            if (nac.neoConnection === true) {
                if (dta.dbname && dta.dbname.length > 0) {
                    if (dta.dbname != "system" && dta.dbname != "<none>") {
    ...
    _buildQueryLog(index, showAll){
        ...
        contents += "<div class='ui message' style='width: 15950px;'><div class='header'><button class=\"ui icon button\" onclick=\"qan.clearAppLogFile()\"><i class=\"eraser icon\"></i></button>";
        if (applyFilter) {
            let dbstr = "";
        ...
        for (let i = 0; i < this.log.length; i++) {
            ...
            if (nac.neoConnection === true && dbn !== "system" && dbn !== "<none>" && dbn !== "") {
