...
class QueryAnalyzer {
            ...
            if (nac.neodb.majorVersion > 3 || (nac.neodb.majorVersion == 3 && nac.neodb.minorVersion > 1 )) {
                ...
                if (nac.neodb.majorVersion > 4) {
                    qry = "call dbms.listConfig() yield name, value, dynamic, description \n" +
                        "where name in [\"db.logs.query.allocation_logging_enabled\"    \n" +
                        "              ,\"db.logs.query.enabled\"\n" +
                        "              ,\"db.logs.query.page_logging_enabled\"\n" +
                        ...
                        "              ,\"db.track_query_allocation\"\n" +
                        "              ,\"db.track_query_cpu_time\"\n" +
                        "              ,\"db.logs.query.runtime_logging_enabled\"]\n" +
    ...
    _buildQSettingsScreenSingle() {
        ...
        console.log(this.logConfig);
        console.log("AAAAAAAAAAAAAAAAAAAAAAAAARGH");
        console.log("NANANANAAAAAAAAAAAAAAAAAAAAAAAAARGH");
    ...
    __analyseLogEntry(curLine, srv, map) {
        ...
        let isJSON = curLine.substring(0,9) == '{"time":"';
        ...
        //
        if (isJSON === true ||record.length == 9 || record.length == 8 || record.length == 5 || record.length == 3 || record.length == 7 || record.length > 9 ) {
            let qrec = '';
            if (isJSON === true) {
